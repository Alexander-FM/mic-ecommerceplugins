...
public class ProductController {
  ...
  public ResponseEntity<GenericResponse<List<ProductInfo>>> getProductsByCategoryId(@PathVariable final Integer categoryId) {
    return ResponseEntity.status(HttpStatus.OK).body(this.service.findByCategoryId(categoryId));
  }
